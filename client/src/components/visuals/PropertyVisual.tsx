    ...
    <g>
      <defs>
        ...
        <linearGradient id="rv-sky" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#231a0f" />
        ...
        <linearGradient id="rv-floor" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#251d12" />
      ...
      <rect x="340" y="60" width="420" height="430" fill="none" stroke="#3b2e1d" strokeWidth="2" />

      <circle cx="680" cy="170" r="26" fill="#f3e6cd" opacity="0.9" />
      ...
      <rect x="0" y="494" width="800" height="1.5" fill="#403326" />

      <line x1="120" y1="494" x2="120" y2="250" stroke="#4b3c28" strokeWidth="4" strokeLinecap="round" />
      <line x1="124" y1="494" x2="124" y2="250" stroke="#584830" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M96 250 Q120 232 148 250 L128 250 Q120 244 112 250 Z" fill="#4b3c28" />
      <circle cx="120" cy="235" r="14" fill="#4b3c28" />
      ...
      <path
        ...
        opacity="0.85"
      />
      <rect x="472" y="585" width="88" height="11" rx="5" fill="#100b06" />
    </g>
  )
}
...
function DawnScene({ accent }: { accent: AccentPalette }) {
  return (
    <g>
      ...
      <rect x="60" y="70" width="500" height="380" fill="none" stroke="#382c1b" strokeWidth="2" />

      <rect x="60" y="70" width="500" height="14" fill="#2f2417" />

      <line x1="130" y1="84" x2="130" y2="440" stroke="#3b2f1e" strokeWidth="2" />
      <line x1="430" y1="84" x2="430" y2="440" stroke="#3b2f1e" strokeWidth="2" />
      <line x1="60" y1="180" x2="560" y2="180" stroke="#342818" strokeWidth="2" />
      <line x1="60" y1="300" x2="560" y2="300" stroke="#342818" strokeWidth="2" />
      ...
      <rect x="620" y="140" width="120" height="200" rx="4" fill="#20170f" stroke="#3d3020" strokeWidth="1.5" />
      <rect x="670" y="180" width="20" height="120" rx="2" fill={`rgba(${accent.rgb}, 0.35)`} />
      <rect x="645" y="352" width="70" height="8" rx="4" fill="#2b2114" />

      <rect x="150" y="470" width="500" height="130" fill="#150f09" />
      <rect x="150" y="470" width="500" height="1.5" fill="#3b2e1e" />

      <path d="M190 470 L232 470 L232 410 L190 410 Z" fill="#221910" />
      <rect x="196" y="416" width="30" height="48" rx="10" fill={`rgba(${accent.rgb}, 0.14)`} />
      <rect x="184" y="470" width="54" height="10" rx="5" fill="#191108" />

      <path d="M600 470 L590 440 C586 424 588 415 600 415 C612 415 614 424 610 440 L600 470 Z" fill="#20170f" />
    </g>
  )
}
    ...
    <g>
      <defs>
        <linearGradient id="rv-eve-wall" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#1b130b" />
          <stop offset="100%" stopColor="#0e0a06" />
        </linearGradient>
      ...
      <rect x="160" y="280" width="240" height="170" rx="4" fill="#160f09" stroke="#3b2e1d" strokeWidth="1.5" />
      <g transform="translate(190, 310)">
        <text y="34" fontFamily="Space Grotesk, sans-serif" fontWeight="500" fontSize="20" letterSpacing="6" fill="#52432c">
          AURA
        </text>
        <rect y="58" width="180" height="2" fill={`rgba(${accent.rgb}, 0.5)`} />
        <rect y="72" width="150" height="2" fill="#322719" />
        <rect y="82" width="170" height="2" fill="#2b2113" />
        <rect y="92" width="120" height="2" fill="#2b2113" />
      </g>

      <rect x="0" y="450" width="800" height="150" fill="#110b07" />
      <rect x="0" y="450" width="800" height="1.5" fill="#3b2e1d" />

      <rect x="90" y="330" width="120" height="120" rx="6" fill="#160f09" stroke="#3e3020" strokeWidth="1.5" />
      <rect x="108" y="348" width="84" height="84" rx="3" fill={`rgba(${accent.rgb}, 0.12)`} />

      <line x1="620" y1="450" x2="620" y2="210" stroke="#4b3c28" strokeWidth="4" strokeLinecap="round" />
      <path d="M596 210 Q620 188 646 210 L624 210 Q620 202 618 210 Z" fill="#4b3c28" />
      ...
      <path
        ...
        opacity="0.8"
      />
      <rect x="246" y="452" width="88" height="10" rx="5" fill="#110b07" />
    </g>
  )
}
